...
if($_SERVER['REQUEST_METHOD']=="POST")
{
    ...
    {
        $query = "insert into iTaxOpenSpaceRentalIncomeSuperAdmin (TaxName,MaintnceFeeRate,TaxArea,BankSwiftCode,BankName,AccountName,PayBillNo,AccountNO)
        Values ('$TaxName','$MaintnceFeeRate','$TaxArea','$BankSwiftCode','$BankName','$AccountName','$PayBillNo','$AccountNO')";

        mysqli_query($con,$query);
        {
            header("location: iTaxOpenSpaceRentalIncomeSuperAdmin.php");
            die;
        }
    }
    else
...
<fieldset>
<legend>OpenSpace TAX SuperAdminArea: </legend>
