...
<a href="HotelAccomodationCalculater.php" style="color:red"><input type="text2"  value="<<< Back" readonly="readonly" ></a>
</div>   
<div class="container tbl-container">
      ...
      <th>BankAccNo</th>
        ...
        <?php
					include('conn1.php');
					$query=mysqli_query($conn,"select * from `HotelAccomodationCalculater`");
					while($row=mysqli_fetch_array($query)){
						?>
						<tr>
			              <td><?php echo $row['Door']; ?></td>
                          <td><?php echo $row['SuiteUniqueNo']; ?></td>
			              <td><?php echo $row['BussRegName']; ?></td>
                          <td><?php echo $row['BranchName']; ?></td>
                          <td><?php echo $row['BranchNO']; ?></td>
                          <td><?php echo $row['HotelBankSwiftCode']; ?></td> 
                          <td><?php echo $row['HotelMPESABusinessNo']; ?></td> 
                          <td><?php echo $row['HotelBankAccNo']; ?></td> 
                          
                          
						
						
							<td>
								<a href="eHotelAccomodationChangesedit.php?ID=<?php echo $row['ID']; ?>" style="color:red">ADD/UPDATE</a>
								<a href=""></a>
							</td>
						</tr>
						<?php
