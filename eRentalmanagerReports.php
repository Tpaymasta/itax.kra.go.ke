...
<a href="dashboard.php" ><input type="text3"  value="<<Back" readonly="readonly" ></a><br><br>
<fieldset>
          <legend>Rental Reports Area: </legend>
  
               
               <a href="EventMonitor.php"><input type="Reports"   value="EVENT MONITOR" readonly="readonly"></a>
               <a href="crystalRESIDENCIAL.php"> <input type="Reports" value="RESIDENCIAL RENTA REPORTS" readonly="readonly"> </a>
               <a href="crystalComercial.php"> <input type="Reports" value="COMERCIALL RENTA REPORTS" readonly="readonly"> </a>
               <a href="crystalOPENSPACE.php"><input type="Reports"   value="OPENSPACE RENTAL REPORTS" readonly="readonly"></a>
               <a href="crystalSHOPS.php"><input type="Reports"   value="SHOPS RENTAL REPORTS" readonly="readonly"></a>
               <a href="crystalSTALLS.php"><input type="Reports"   value="STALLS RENTAL REPORTS" readonly="readonly"></a>
               <a href="reportsumery.php"><input type="Reports"   value="REPORT SUMMERY" readonly="readonly"></a>
</fieldset>
           <br>
<fieldset>
          <legend>File Rental Returns: </legend>
 
  <a href="e-ReturnAckowledgmentReceipt.php"><input type="returns"   value="FILE RETURN " readonly="readonly"></a>
  <a href=""><input type="returns"   value="" readonly="readonly"></a>
