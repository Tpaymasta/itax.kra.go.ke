...
<fieldset>
          <legend>Residencial Reports: </legend>
          <a href="CrystalReport.php"> <input type="text" value="Pull Report" readonly="readonly"> </a>
               <a href=""><input type="text"   value="Query DoorReport" readonly="readonly"></a>
               <a href=""><input type="text"   value="Query BlockReport" readonly="readonly"></a>
               <a href=""><input type="text"   value="Pull Wholereport" readonly="readonly"></a>
