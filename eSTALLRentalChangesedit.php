...
<a href="STALLRentalCalculater.php" style="color:red">
               <input type="text2"  value="HOME" readonly="readonly" ></a>
<input type="text3"  value="Change Ownership" readonly="readonly" ></a>

TenantID/PassPort: 

<a href="eSTALLRentalChangesTenantedit.php?ID=<?php echo $row['ID']; ?>" style="color:red">
<input type="text3"  value="<?php echo $row['IDNO']; ?> <?php echo $row['PassPortNO']; ?>" readonly="readonly" ></a>
...
<form method="POST" action="eSTALLRentalChangesUpdate.php?ID=<?php echo $ID; ?>">

					 
 <fieldset>
          <legend>STALL Rental Configuration </legend>
             <label type="text">KRAPIN</label>
               <input type="text" name="KRAPIN" value="<?php echo $row['KRAPIN']; ?>" id="" readonly="readonly" >
               <label type="text">PlotNo</label>
                <input type="text" name="PlotNo" value="<?php echo $row['PlotNo']; ?>" id="" placeholder="Enter PlotNo"  required >
            
                <label type="text">FloorNo</label>
               <input type="number" name="FloorNo" value="<?php echo $row['FloorNo']; ?>" id="" placeholder="Enter FloorNo" required ><br><br><br>
               <label type="text">SuiteNo</label>
               <input type="number" name="SuiteNo" value="<?php echo $row['SuiteNo']; ?>" id="" placeholder="Enter DoorNo" required >
               ...
               <label type="text">Gross KSH:</label>
               <input type="text" name="GrossRent" value="<?php echo $row['GrossRent']; ?>" id="GrossRent"oninput="valid(this)"type="text" placeholder="0.00" minlength="1" maxlength="10" required>
               ...
               <input type="test" name="Door"  class="form-control" id="text" value=" <?php echo $row['BlockName']; echo $row['SuiteNo'];?> " readonly='readonly' minlength="2" maxlength="5"  required>
...
<fieldset>
          ...
          <label type="text">Bank SwiftCode</label>
               <div class="WING" required>
                <select name="BankSwiftCode" value="<?php echo $row['BankSwiftCode']; ?>" class="" required>
...
<label type="text">BankName</label>
               <div class="WING" required>
                <select name="BankName" value="<?php echo $row['BankName']; ?>" class="" required>
          ...
          <label type="text">BusinessNo</label>
               <div class="WING" required>
                <select name="Bank1PayBillNO1" value="<?php echo $row['Bank1PayBillNO1']; ?>" class="" required>
          ...
          <label type="text">AccountNO</label>
               <input type="text" name="Bank1AccountNO1" value="<?php echo $row['Bank1AccountNO1']; ?>" id="Bank1AccountNO1" oninput="valid(this)"type="text"placeholder="Enter ACCOUNTNO" required >
</fieldset>

<div class="container2d4">
              
               <a href="eSTALLRentalChangesIndex.php" style="color:red">
    ...
    <script>
        ...
        function valid(elem) {
            if (RegExp.test(elem.value)) {
               ...
               <input type="test" name="ContactNO" value="<?php echo $row['ContactNO']; ?>" id="ContactNO"  placeholder="TenantContactNO" >
               <input type="test" name="JoinedDate" value="<?php echo $row['JoinedDate']; ?>" id="JoinedDate"  placeholder="Enter JoinedDate" >
