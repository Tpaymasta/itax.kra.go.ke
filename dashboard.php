 ...
 >
   ...
   <li class="dropdown">
     ...
     <div class="dropdown-content">
       ...
       <a href="./Daraja1/index.php">Pay Fines</a>
...
<button onclick="myFunction4()" type="button" class="e-RealEstate" > T-PayMasTaRental</button>
        <div id="e-RealEstate">
...
<button onclick="myFunction5()" type="button" class="e-RetailBusiness" > T-PayMasTaRetail</button>
...
<button onclick="myFunction6()" type="button" class="e-Cheques" > T-PayMasTaCheques</button>
        <div id="e-Cheques">
...
<button onclick="myFunction7()" type="button" class="e-Employer" >T-PayMasTaEmployer</button>
        <div id="e-Employer">
...
<button onclick="myFunction8()" type="button" class="e-Suppliers_Contractor" > T-PayMasTaSuppliers</button>
