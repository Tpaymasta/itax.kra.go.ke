...
<form method="POST" action="eHotelAccomodationChangesUpdate.php?ID=<?php echo $ID; ?>">
      ...
      <fieldset>
          <legend>Hotel Configuration Area: </legend>
             ...
             <label type="text">Buss RegName</label>
                <input type="text" name="BussRegName" value="<?php echo $row['BussRegName']; ?>" id="" placeholder="Enter BussRegName"   >
               <label type="text">PlotNo</label>
                <input type="text" name="PlotNo" value="<?php echo $row['PlotNo']; ?>" id="" placeholder="Enter PlotNo"   >
            
                <label type="text">BranchNO</label>
               <input type="number" name="BranchNO" value="<?php echo $row['BranchNO']; ?>" id="" placeholder="Enter BranchNO"  ><br><br><br>
               <label type="text">SuiteNo</label>
               <input type="number" name="SuiteNo" value="<?php echo $row['SuiteNo']; ?>" id="" placeholder="Enter DoorNo"  >
          ...
          <label type="text">BranchName</label>
               <input type="text" name="BranchName" value="<?php echo $row['BranchName']; ?>" id="BranchName"  placeholder="Enter BranchName"  >
...
<fieldset>
          ...
          <label type="text">Bank SwiftCode</label>
               <div class="WING" required>
                <select name="BankSwiftCode" value="<?php echo $row['BankSwiftCode']; ?>" required>
          ...
          <label type="text">BankName</label>
               <div class="WING" required>
                <select name="HotelBankName" value="<?php echo $row['HotelBankName']; ?>" required>
          ...
          <label type="text">BusinessNo</label>
               <div class="WING" required>
                <select name="HotelMPESABusinessNo" value="<?php echo $row['HotelMPESABusinessNo']; ?>" required>
               ...
               <input type="text" name="HotelBankAccNo" value="<?php echo $row['HotelBankAccNo']; ?>" id="HotelBankAccNo" oninput="valid(this)"type="text"placeholder="Enter ACCOUNTNO" required >
