...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    ...
    $sql = sprintf("SELECT * FROM SignupCitizens
                    WHERE NationalID = '%s'",
...
<fieldset>
          <legend>Rental Cofiguratioon Area </legend>
   
               <a href="ComercialRentalCalculater.php"><input type="tel"   value="COMMERCIAL RENTALS CONFIGURATIONS" readonly="readonly"></a>
               <a href="OpenSpaceRentalCalculater.php"><input type="tel"   value="OPENSPACE RENTALS CONFIGURATIONS" readonly="readonly"></a>
               <a href="ResidencialRentalCalculater.php"> <input type="tel" value="RESIDENCIAL RENTALS CONFIGURATIONS" readonly="readonly"> </a>
               <a href="SHOPRentalCalculater.php"><input type="tel"   value="SHOPS RENTALS CONFIGURATIONS" readonly="readonly"></a>
               <a href="STALLRentalCalculater.php"><input type="tel"   value="STALLS RENTALS CONFIGURATIONS" readonly="readonly"></a>
               <a href="AirB&BAccomodationCalculater.php"><input type="tel"   value="AirB&B SPACE" readonly="readonly"></a><br>
               <a href="HotelAccomodationCalculater.php"><input type="tel"   value="HOTEL ACCOMODATION CONFIGURATIONS" readonly="readonly"></a>
               <a href=""><input type="tel"   value="" readonly="readonly"></a>
</fieldset>
<br>
<fieldset>
          <legend> Rental Changes Area </legend>
               <a href="eComercialRentalChangesIndex.php"><input type="changes"   value="COMMERCIAL RENTAL CHANGES" readonly="readonly"></a>
               <a href="eOpenSpaceRentalChangesIndex.php"><input type="changes"   value="OPENSPACE RENTAL CHANGES" readonly="readonly"></a>
               <a href="eResidencialRentalChangesIndex.php"> <input type="changes" value="RESIDENCIAL RENTA LCHANGES" readonly="readonly"> </a>
               <a href="eSHOPRentalChangesIndex.php"><input type="changes"   value="SHOPS RENTAL CHANGES" readonly="readonly"></a>
               <a href="eSTALLRentalChangesIndex.php"><input type="changes"   value="STALLS RENTAL CHANGES" readonly="readonly"></a>
               <a href="eAirB&BAccomodationChangesIndex.php"><input type="changes"   value="AirB&B" readonly="readonly"></a>
               <a href=""><input type="changes"   value="HOTEL CONFIGURATIONS CHANGES" readonly="readonly"></a>
               <a href=""><input type="changes"   value="" readonly="readonly"></a>
</fieldset>
