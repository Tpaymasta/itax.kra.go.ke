...
if($_SERVER['REQUEST_METHOD']=="POST")
{
    ...
    {
        $query = "insert into iTaxOpenSpaceRentalIncomeAdmin (TaxName,TAXRate,TaxArea,BankSwiftCode,BankName,AccountName,PayBillNo,AccountNO)
        Values ('$TaxName','$TAXRate','$TaxArea','$BankSwiftCode','$BankName','$AccountName','$PayBillNo','$AccountNO')";

        mysqli_query($con,$query);
        {
            header("location: iTaxOpenSpaceRentalIncomeAdmin.php");
            die;
        }
    }
    else
...
<fieldset>
          <legend>OpenSpaceRental TAX AdminArea: </legend>
             ...
             <div class="WING" required>
               ...
               <div class="WING" required>
                <select name="TaxArea" class="" required>
                    ...
                    <option value="OpenSpace Rental">OpenSpace Rental</option>
                </select>
          </div>         
          ...
          <label type="text">BankName</label>
               <div class="WING" required>
                <select name="BankName" class="" required>
                    ...
                    <option value="ABC BANK LTD">ABC BANK LTD </option>
                </select>
          </div>
          ...
          <label type="text">Bank SwiftCode</label>
               <div class="WING" required>
                <select name="BankSwiftCode" class="" required>
                    ...
                    <option value="ABCLKENA">ABCLKENA</option>
                </select>
          </div>
          ...
          <label type="text">BusinessNo</label>
               <div class="WING" required>
                <select name="PayBillNo" class="" required>
                    ...
                    <option value="111777">111777 </option>
                </select>
          </div>
          ...
          <label type="text">Bank AccountNO</label>
               <div class="WING" required>
                <select name="AccountNO" class="" required>
                    ...
                    <option value="1001314398">1001314398</option>
                    <option value="001200001000724">001200001000724</option>
                </select>
          </div><br><br><br>
