...
<a href="ResidencialRentalDoorUniqueNoIndex.php" ><input type="text3"  value="Back" readonly="readonly" ></a>
...
<form method="POST" action="eResidencialRentalDoorUniqueNOUpdate.php?ID=<?php echo $ID; ?>">
