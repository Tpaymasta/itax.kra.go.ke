<?php
	...
	mysqli_query($conn,"update `AirBBAccomodationCalculater` set 
    ...
    where ID='$ID'");
	header('location:eAirB&BAccomodationDoorUniqueNoIndex.php');
?>

<?php
	include('conn1AirBnBData.php');
	$ID=$_GET['ID'];
...
<?php
	...
	mysqli_query($conn,"update `AirBBAccomodationCalculaterBackUp` set 
