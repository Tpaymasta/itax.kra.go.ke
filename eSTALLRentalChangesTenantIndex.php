...
<a href="STALLRentalCalculater.php" style="color:red"><input type="text2"  value="<<< Back" readonly="readonly" ></a>
</div>   
<div class="container tbl-container">
      ...
      <th>Print INVOICE</th>
        ...
        <?php
					include('conn1.php');
					$query=mysqli_query($conn,"select * from `STALLRentalCalculater`");
              ...
              <td><?php echo $row['SuiteUniqueNo']; ?></td>
							...
							<td>
								<a href="eSTALLRentalChangesTenantedit.php?ID=<?php echo $row['ID']; ?>" style="color:red">ADD/UPDATE</a>
              </td>
                <td>
								<a href="eSTALLRentalChangesTenantedit1.php?ID=<?php echo $row['ID']; ?>" style="color:red">INVOICE</a>
							</td>
						</tr>
						<?php 
					}
