...
if($_SERVER['REQUEST_METHOD']=="POST")
{
    ...
    {
        $query = "insert into OpenSpaceRentalCalculater (KRAPIN,PlotNo,FloorNo,SuiteNo,BlockName,SuiteUniqueNo,
        ...
        {
            header("location: OpenSpaceRentalCalculater.php");
            die;
        }
    }
    else
...
<a href="eOpenSpaceRentalChangesIndex.php" ><input type="text3" value="View DoorS" readonly="readonly"></a>
<a href="OpenSpaceRentalDoorUniqueNoIndex.php" ><input type="text3" value="Add DoorUniqueNO" readonly="readonly"></a>
<a href="eOpenSpaceRentalChangesTenantIndex.php" ><input type="text3" value="View Tenants" readonly="readonly"></a>
</div>
...
<?php
					...
					$query=mysqli_query($conn,"select * from `itaxOpenSpacerentalincomeadmin`");
...
<?php
					...
					$query=mysqli_query($conn,"select * from `iTaxOpenSpaceRentalIncomeSuperAdmin`");
					while($row=mysqli_fetch_array($query)){
						?>
