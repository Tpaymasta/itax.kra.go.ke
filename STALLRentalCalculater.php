...
if($_SERVER['REQUEST_METHOD']=="POST")
{
    ...
    {
        $query = "insert into STALLRentalCalculater (KRAPIN,PlotNo,FloorNo,SuiteNo,BlockName,SuiteUniqueNo,
        ...
        {
            header("location: STALLRentalCalculater.php");
            die;
        }
    }
    else
...
<a href="eSTALLRentalChangesIndex.php" ><input type="text3" value="View DoorS" readonly="readonly"></a>
<a href="STALLRentalDoorUniqueNoIndex.php" ><input type="text3" value="Add DoorUniqueNO" readonly="readonly"></a>
<a href="eSTALLRentalChangesTenantIndex.php" ><input type="text3" value="View Tenants" readonly="readonly"></a>
</div>
...
<?php
					...
					$query=mysqli_query($conn,"select * from `itaxSTALLrentalincomeadmin`");
...
<?php
					...
					$query=mysqli_query($conn,"select * from `iTaxSTALLRentalIncomeSuperAdmin`");
					while($row=mysqli_fetch_array($query)){
						?>
