...
<a href="ComercialRentalDoorUniqueNoIndex.php" ><input type="text3"  value="Back" readonly="readonly" ></a>
...
<form method="POST" action="eComercialRentalDoorUniqueNOUpdate.php?ID=<?php echo $ID; ?>">
