...
<a href="ResidencialRentalCalculater.php" style="color:red">
               <input type="text2"  value="HOME" readonly="readonly" ></a>
<input type="text3"  value="Change Ownership" readonly="readonly" ></a>

TenantID/PassPort: 

<a href="eResidencialRentalChangesTenantedit.php?ID=<?php echo $row['ID']; ?>" style="color:red">
...
<form method="POST" action="eResidencialRentalChangesUpdate.php?ID=<?php echo $ID; ?>">
...
<div class="container2d4">
               ...
               <a href="eResidencialRentalChangesIndex.php" style="color:red">
