...
if($_SERVER['REQUEST_METHOD']=="POST")
{
    ...
    if(!empty($TAXRate) && !empty($PayBillNo) )
    {
        $query = "insert into iTaxSHOPRentalIncomeAdmin (TaxName,TAXRate,TaxArea,BankSwiftCode,BankName,AccountName,PayBillNo,AccountNO)
        Values ('$TaxName','$TAXRate','$TaxArea','$BankSwiftCode','$BankName','$AccountName','$PayBillNo','$AccountNO')";

        mysqli_query($con,$query);
        {
            header("location: iTaxSHOPRentalIncomeAdmin.php");
            die;
        }
    }
    else
...
<fieldset>
<legend>SHOPRental TAX AdminArea: </legend>
             ...
             <div class="WING" required>
               ...
               <label type="text">TAXRate</label>
               <div class="WING" required>
                <select name="TAXRate" class="" required>
...
<br>
     ...
     <fieldset>
          ...
          <label type="text">BankName</label>
               <div class="WING" required>
                <select name="BankName" class="" required>
                    ...
                    <option value="CO-OP BANK KENYA">CO-OP BANK KENYA</option>
                    <option value="FAMILY BANK LIMITED">FAMILY BANK LIMITED</option>
          ...
          <label type="text">Bank SwiftCode</label>
               <div class="WING" required>
                <select name="BankSwiftCode" class="" required>
                    ...
                    <option value="KCOOKENA">KCOOKENA</option>
                    <option value="FABLKENA">FABLKENA</option>
          ...
          <label type="text">Account Name</label>
               <div class="WING" required>
                <select name="AccountName" class="" required>
                    <option value="">AccountName</option>
                    <option value="Kenya Revenue Authority Collection Account">KRA Collection Acc</option>
                </select>
          ...
          <label type="text">BusinessNo</label>
               <div class="WING" required>
                <select name="PayBillNo" class="" required>
                    ...
                    <option value="222111">222111</option>
                </select>
          </div>

          <label type="text">Bank AccountNO</label>
               <div class="WING" required>
                <select name="AccountNO" class="" required>
                    <option value="">BankAccountNO</option>
                    <option value="01136001340300">01136001340300</option>
                    <option value="06800011053">06800011053</option>
                </select>
          </div><br><br><br>
