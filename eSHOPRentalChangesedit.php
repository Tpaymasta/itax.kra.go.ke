...
<a href="SHOPRentalCalculater.php" style="color:red">
               <input type="text2"  value="HOME" readonly="readonly" ></a>
<input type="text3"  value="Change Ownership" readonly="readonly" ></a>

TenantID/PassPort: 

<a href="eSHOPRentalChangesTenantedit.php?ID=<?php echo $row['ID']; ?>" style="color:red">
...
<form method="POST" action="eSHOPRentalChangesUpdate.php?ID=<?php echo $ID; ?>">

			
 <fieldset>
          <legend>SHOP Rental Configuration </legend>
             <label type="text">KRAPIN</label>
               ...
               <input type="text" name="Bank1PayBillNO1" value="<?php echo $row['Bank1PayBillNO1']; ?>" id="Bank1PayBillNO1" oninput="valid(this)"type="text" placeholder="Enter PAYBILLNO" minlength="6" maxlength="6" required><br><br><br>
...
<div class="container2d4">
               ...
               <a href="eSHOPRentalChangesIndex.php" style="color:red">
