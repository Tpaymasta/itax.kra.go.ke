<?php
	include('conn1.php');
	$ID=$_GET['ID'];
	$query=mysqli_query($conn,"select * from `ComercialRentalCalculater` where ID='$ID'");
...
<a href="eComercialRentalChangesTenantIndex1.php" style="color:red"><input type="text2"  value="Invoice Tenant" readonly="readonly" ></a>
...
<form method="POST" action="eComercialRentalChangesTenantUpdate.php?ID=<?php echo $ID; ?>">
...
<fieldset>
      ...
      <div class="container2d4">
               ...
               <a href="eComercialRentalChangesTenantIndex.php" style="color:red">
