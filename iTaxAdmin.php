...
<fieldset>
          <legend>Rental Tax Cofiguratioon Area </legend>
   
               <a href="iTaxComercialRentalIncomeAdmin.php"><input type="tel"   value="COMMERCIAL RENTALS CONFIGURATIONS" readonly="readonly"></a>
               <a href="iTaxOpenSpaceRentalIncomeAdmin.php"><input type="tel"   value="OPENSPACE RENTALS CONFIGURATIONS" readonly="readonly"></a>
               <a href="iTaxResidencialRentalIncomeAdmin.php"> <input type="tel" value="RESIDENCIAL RENTALS CONFIGURATIONS" readonly="readonly"> </a>
               <a href="iTaxSHOPRentalIncomeAdmin.php"><input type="tel"   value="SHOPS RENTALS CONFIGURATIONS" readonly="readonly"></a>
               <a href="iTaxSTALLRentalIncomeAdmin.php"><input type="tel"   value="STALLS RENTALS CONFIGURATIONS" readonly="readonly"></a>
