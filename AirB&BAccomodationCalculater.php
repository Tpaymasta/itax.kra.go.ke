...
<a href="eAirB&BAccomodationChangesIndex.php" ><input type="text3" value="View DoorS" readonly="readonly"></a>
<a href="eAirB&BAccomodationDoorUniqueNoIndex.php" ><input type="text3" value="Add DoorUniqueNO" readonly="readonly"></a>
<a href="eAirB&BAccomodationChangesTenantIndex.php" ><input type="text3" value="View Tenants" readonly="readonly"></a>
</div>
...
<form action="ConnectAirBnBAccomodation.php" method="POST">
...
<?php
    ...
    <fieldset>
          <legend>AirBnB  Configuration : </legend>
...
<fieldset>
          ...
          <label type="text">BankName</label>
               <div class="WING" required>
                <select name="BankName" class="" required>
                    ...
                    <option value="CO-OPERATIVE BANK">NCBA BANK KENYA </option>
                    <option value="ECOBANK BANK  KENYA">ECOBANK BANK KENYA </option>
                    <option value="NATIONAL BANK OFKENYA">NATIONAL BANK OFKENYA </option>
                </select>
          </div>
          ...
          <label type="text">Bank SwiftCode</label>
               <div class="WING" required>
                <select name="BankSwiftCode" class="" required>
                    ...
                    <option value="ECOCKENA">ECOCKENA</option>
                    <option value="NBKEKENX">NBKEKENX</option>
                </select>
          </div>
          ...
          <label type="text">BusinessNo</label>
               <div class="WING" required>
                <select name="Bank1PayBillNO1" class="" required>
                    ...
                    <option value="700201">700201 </option>
                    <option value="625625">625625 </option>
                </select>
          </div><br><br><br>
