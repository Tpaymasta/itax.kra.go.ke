...
if($_SERVER['REQUEST_METHOD']=="POST")
{
    ...
    {
        $query = "insert into ResidencialRentalData (KRAPIN,PlotNo,FloorNo,SuiteNo,SuiteUniqueNo,
        ...
        TENANTKRAPIN,IDNO,PassPortNO,Nationality,LastName,FirstName,ContactNO,SetUpDate,JoinedDate,ExitDate)
        Values ('$KRAPIN','$PlotNo','$FloorNo','$SuiteNo','$SuiteUniqueNo',
        '$Bank1PayBillNO1','$Bank1AccountNO1','$GrossRent','$NetRent','$TAXRate','$TaxValue','$MaintnceFeeRate','$TaxAvailable',
        '$Bank2PayBillNO2','$Bank2AccountNO2','$MaintenanceFee','$Bank3PayBillNO3','$Bank3AccountNO3',
        '$TENANTKRAPIN','$IDNO','$PassPortNO','$Nationality','$LastName','$FirstName','$ContactNO',
        '$SetUpDate','$JoinedDate','$ExitDate')";

        mysqli_query($con,$query);
        {
            header("location:  ResidencialRentalData.php");
            die;
        }
    }
    else
...
<a href="eResidencialRentalChangesIndex.php" style="color:red">Make Changes Here</a></div>
...
<fieldset>
          <legend>Plot Configuration Area: </legend>
             <label type="text">KRAPIN</label>
               ...
               <input type="text" name="Bank1AccountNO1" value="" id="Bank1AccountNO1" oninput="valid(this)"type="text"placeholder="Enter ACCOUNTNO" required ><br><br><br>
               <label type="text">SetUpDate</label>
               <input type="date" name="SetUpDate" value="" id="SetUpDate"  placeholder="Enter SetUpDate" required>
               <label type="text">GrossRent KSH:</label>
         
               <input type="text" name="GrossRent" value="" id="GrossRent"oninput="valid(this)"type="text" placeholder="0.00"  required>
</fieldset>
<br>
<fieldset>
               <legend>Tenancy Configuration Area: </legend>
               <label type="text">Door UniqueNo</label>
               <input type="text" name="SuiteUniqueNo"  class="form-control" name="barcode" value="" id="text" placeholder="Enter DoorUniqueNo" required >
</fieldset>
    ...
    <script>
        ...
        function valid(elem) {
          ...
          <label type="text1">TENANT KRAPIN</label>
               <input type="text" name="TENANTKRAPIN" value="" id="" placeholder="Enter TENANTKRAPIN"  >
               <label type="text1">IDNO</label>
                <input type="text" name="IDNO" value="" id="IDNO" oninput="valid(this)" placeholder="Enter IDNO" minlength="8" maxlength="8"  >
                <label type="text1">PassPortNO</label>
               <input type="text" name="PassPortNO" value="" id="" placeholder="Enter PassPortNO"  ><br><br><br>
               <label type="text1">Nationality</label>
               <input type="text" name="Nationality" value="" id="" placeholder="Enter Nationality"  >
               <label type="text1">LastName</label>
               <input type="text" name="LastName" value="" id="LastName"  placeholder="Enter LastName" >
               <label type="text1">FirstName</label>
               <input type="text" name="FirstName" value="" id="FirstName"  placeholder="Enter FirstName" ><br><br><br>
               <label type="text1">ContactNO</label>
               <input type="text" name="ContactNO" value="" id="ContactNO" oninput="valid(this)" placeholder="Tenant ContactNO" minlength="10" maxlength="10" >
               <label type="text1">JoinedDate</label>
               <input type="date" name="JoinedDate" value="" id="JoinedDate"  placeholder="Enter JoinedDate" >
               <label type="text1">ExitDate</label>
               <input type="date" name="ExitDate" value="" id="ExitDate"  placeholder="Enter ExitDate" >
      </fieldset>
