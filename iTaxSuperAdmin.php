...
<fieldset>
          <legend>Rental SeviceFee Cofiguratioon Area </legend>
   
               <a href="iTaxComercialRentalIncomeSuperAdmin.php"><input type="tel"   value="COMMERCIAL RENTALS CONFIGURATIONS" readonly="readonly"></a>
               <a href="iTaxOpenSpaceRentalIncomeSuperAdmin.php"><input type="tel"   value="OPENSPACE RENTALS CONFIGURATIONS" readonly="readonly"></a>
               <a href="iTaxResidencialRentalIncomeSuperAdmin.php"> <input type="tel" value="RESIDENCIAL RENTALS CONFIGURATIONS" readonly="readonly"> </a>
               <a href="iTaxSHOPRentalIncomeSuperAdmin.php"><input type="tel"   value="SHOPS RENTALS CONFIGURATIONS" readonly="readonly"></a>
               <a href="iTaxSTALLRentalIncomeSuperAdmin.php"><input type="tel"   value="STALLS RENTALS CONFIGURATIONS" readonly="readonly"></a>
               <a href=""><input type="tel"   value="AirB&B SPACE" readonly="readonly"></a><br>
               <a href=""><input type="tel"   value="HOTEL ACCOMODATION CONFIGURATIONS" readonly="readonly"></a>
