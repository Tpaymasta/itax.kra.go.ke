...
<a href="OpenSpaceRentalCalculater.php" style="color:red">
               <input type="text2"  value="HOME" readonly="readonly" ></a>
<input type="text3"  value="Change Ownership" readonly="readonly" ></a>

TenantID/PassPort: 

<a href="eOpenSpaceRentalChangesTenantedit.php?ID=<?php echo $row['ID']; ?>" style="color:red">
...
<form method="POST" action="eOpenSpaceRentalChangesUpdate.php?ID=<?php echo $ID; ?>">

			
 <fieldset>
          <legend>OpenSpace Rental Configuration </legend>
...
<div class="container2d4">
               ...
               <a href="eOpenSpaceRentalChangesIndex.php" style="color:red">
