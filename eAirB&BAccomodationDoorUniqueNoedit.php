...
<a href="eAirB&BAccomodationDoorUniqueNoIndex.php" ><input type="text3"  value="Back" readonly="readonly" ></a>
...
<form method="POST" action="eAirB&BAccomodationDoorUniqueNOUpdate.php?ID=<?php echo $ID; ?>">
