<?php
	include('conn1.php');
	$ID=$_GET['ID'];
	$query=mysqli_query($conn,"select * from `STALLRentalCalculater` where ID='$ID'");
...
<a href="eSTALLRentalChangesTenantIndex1.php" style="color:red"><input type="text2"  value="Invoice Tenant" readonly="readonly" ></a>
...
<form method="POST" action="eSTALLRentalChangesTenantUpdate.php?ID=<?php echo $ID; ?>">
...
<fieldset>
      ...
      <div class="container2d4">
               ...
               <a href="eSTALLRentalChangesTenantIndex.php" style="color:red">
