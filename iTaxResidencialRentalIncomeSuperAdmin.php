...
if($_SERVER['REQUEST_METHOD']=="POST")
{
    ...
    {
        $query = "insert into iTaxResidencialRentalIncomeSuperAdmin (TaxName,MaintnceFeeRate,TaxArea,BankSwiftCode,BankName,AccountName,PayBillNo,AccountNO)
        Values ('$TaxName','$MaintnceFeeRate','$TaxArea','$BankSwiftCode','$BankName','$AccountName','$PayBillNo','$AccountNO')";

        mysqli_query($con,$query);
        {
            header("location: iTaxResidencialRentalIncomeSuperAdmin.php");
            die;
        }
    }
    else
...
<fieldset>
<legend>ResidencialRental TAX SuperAdminArea: </legend>
