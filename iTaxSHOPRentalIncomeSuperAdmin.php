...
if($_SERVER['REQUEST_METHOD']=="POST")
{
    ...
    {
        $query = "insert into iTaxSHOPRentalIncomeSuperAdmin (TaxName,MaintnceFeeRate,TaxArea,BankSwiftCode,BankName,AccountName,PayBillNo,AccountNO)
        Values ('$TaxName','$MaintnceFeeRate','$TaxArea','$BankSwiftCode','$BankName','$AccountName','$PayBillNo','$AccountNO')";

        mysqli_query($con,$query);
        {
            header("location: iTaxSHOPRentalIncomeSuperAdmin.php");
            die;
        }
    }
    else
...
<fieldset>
<legend>SHOPRental TAX SuperAdminArea: </legend>
...
<br>
     ...
     <fieldset>
          ...
          <label type="text">Account Name</label>
               <input type="text" name="AccountName" value="" id="AccountName" placeholder="Account Name" required>
          <label type="text">Account Number</label>
               <input type="text" name="AccountNO" value="" id="AccountNO" placeholder="Account Number" required>
</fieldset>
