...
if($_SERVER['REQUEST_METHOD']=="POST")
{
    ...
    {
        $query = "insert into iTaxSTALLRentalIncomeSuperAdmin (TaxName,MaintnceFeeRate,TaxArea,BankSwiftCode,BankName,AccountName,PayBillNo,AccountNO)
        Values ('$TaxName','$MaintnceFeeRate','$TaxArea','$BankSwiftCode','$BankName','$AccountName','$PayBillNo','$AccountNO')";

        mysqli_query($con,$query);
        {
            header("location: iTaxSTALLRentalIncomeSuperAdmin.php");
            die;
        }
    }
    else
...
<fieldset>
<legend>STALLRental TAX SuperAdminArea: </legend>
