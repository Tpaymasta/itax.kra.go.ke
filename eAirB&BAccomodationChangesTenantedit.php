<?php
	include('conn1.php');
	$ID=$_GET['ID'];
	$query=mysqli_query($conn,"select * from `AirBBAccomodationCalculater` where ID='$ID'");
...
<a href="eRentalmanagerConfiguration.php" style="color:red">
               <input type="text2"  value="HOME" readonly="readonly" ></a>
<a href="" style="color:red"><input type="text3"  value="Erase Tenant" readonly="readonly" ></a>
<a href="eAirB&BAccomodationChangesTenantIndex1.php" style="color:red"><input type="text2"  value="Invoice Tenant" readonly="readonly" ></a>

<a href="" style="color:red"><input type="text2"  value="BlackList Tenant" readonly="readonly" ></a>
...
<form method="POST" action="eAirB&BAccomodationChangesTenantUpdate.php?ID=<?php echo $ID; ?>">
...
<fieldset>
          <legend>Change Tenant Information: </legend>
          <label type="text1">Tenant KRAPIN</label>
               <input type="text" name="TENANTKRAPIN" value="<?php echo $row['TENANTKRAPIN']; ?>" id="" placeholder="Enter TENANTKRAPIN"  >
               <label type="text1">ID NO</label>
                <input type="text" name="IDNO" value="<?php echo $row['IDNO']; ?>" id="IDNO" oninput="valid(this)" placeholder="Enter IDNO" minlength="8" maxlength="8"  >
                <label type="text1">PassPort</label>
               <input type="text" name="PassPortNO" value="<?php echo $row['PassPortNO']; ?>" id="" placeholder="Enter PassPortNO"  ><br><br><br>
               <label type="text1">Nationality</label>
               <input type="text" name="Nationality" value="<?php echo $row['Nationality']; ?>" id="" placeholder="Enter Nationality"  >
               <label type="text1">LastName</label>
               <input type="text" name="LastName" value="<?php echo $row['LastName']; ?>" id="LastName"  placeholder="Enter LastName" >
               <label type="text1">FirstName</label>
               <input type="text" name="FirstName" value="<?php echo $row['FirstName']; ?>" id="FirstName"  placeholder="Enter FirstName" ><br><br><br>
               <label type="text1">ContactNO</label>
               <input type="text" name="ContactNO" value="<?php echo $row['ContactNO']; ?>" id="ContactNO" oninput="valid(this)" placeholder="Tenant ContactNO" >
               <label type="text1">Joined date</label>
               <input type="date" name="JoinedDate" value="<?php echo $row['JoinedDate']; ?>" id="JoinedDate"  placeholder="Enter JoinedDate" >
               <label type="text1">Exit date</label>
               <input type="date" name="ExitDate" value="<?php echo $row['ExitDate']; ?>" id="ExitDate"  placeholder="Enter ExitDate" >
      ...
      <div class="container2d4">
               ...
               <a href="eAirB&BAccomodationChangesTenantIndex.php" style="color:red">
               <input type="text3"  value="Back" readonly="readonly" ></a>
               <input type="text2"  value="<<previous " readonly="readonly">
               <input type="text2"  value="<?php echo $row['ID']; ?>" readonly="readonly">
               <input type="text2"  value="Next>>>" readonly="readonly">
               <button class="btn btn-primary" name="generate">Submit</button>
      </div>
              <input type="test" name="SuiteUniqueNo"  class="form-control" id="text" value=" <?php echo $row['KRAPIN']; echo $row['BlockName']; echo $row['SuiteNo'];?> " readonly='readonly' minlength="13" maxlength="13"  required>
              <input type="test" name="Door"  class="form-control" id="text" value=" <?php  echo $row['BlockName']; echo $row['SuiteNo'];?> " readonly='readonly' minlength="1" maxlength="5"  required>
