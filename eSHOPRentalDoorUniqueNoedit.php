...
>
  ...
  <li class="dropdown">
    ...
    <div class="dropdown-content">
      <a href="SHOPRentalCalculater.php">COMMERCIAL RENTALS </a>
...
<a href="SHOPRentalDoorUniqueNoIndex.php" ><input type="text3"  value="Back" readonly="readonly" ></a>
...
<form method="POST" action="eSHOPRentalDoorUniqueNOUpdate.php?ID=<?php echo $ID; ?>">
