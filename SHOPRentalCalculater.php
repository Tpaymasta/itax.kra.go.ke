...
if($_SERVER['REQUEST_METHOD']=="POST")
{
    ...
    {
        $query = "insert into SHOPRentalCalculater (KRAPIN,PlotNo,FloorNo,SuiteNo,BlockName,SuiteUniqueNo,
        ...
        {
            header("location: SHOPRentalCalculater.php");
            die;
        }
    }
    else
...
<a href="eSHOPRentalChangesIndex.php" ><input type="text3" value="View DoorS" readonly="readonly"></a>
<a href="SHOPRentalDoorUniqueNoIndex.php" ><input type="text3" value="Add DoorUniqueNO" readonly="readonly"></a>
<a href="eSHOPRentalChangesTenantIndex.php" ><input type="text3" value="View Tenants" readonly="readonly"></a>
</div>
...
<?php
					...
					$query=mysqli_query($conn,"select * from `itaxSHOPrentalincomeadmin`");
...
<?php
					...
					$query=mysqli_query($conn,"select * from `iTaxSHOPRentalIncomeSuperAdmin`");
					while($row=mysqli_fetch_array($query)){
						?>
