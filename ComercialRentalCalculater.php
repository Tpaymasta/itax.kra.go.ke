...
if($_SERVER['REQUEST_METHOD']=="POST")
{
    ...
    {
        $query = "insert into ComercialRentalCalculater (KRAPIN,PlotNo,FloorNo,SuiteNo,BlockName,SuiteUniqueNo,
        ...
        {
            header("location: ComercialRentalCalculater.php");
            die;
        }
    }
    else
...
<a href="eComercialRentalChangesIndex.php" ><input type="text3" value="View DoorS" readonly="readonly"></a>
<a href="ComercialRentalDoorUniqueNoIndex.php" ><input type="text3" value="Add DoorUniqueNO" readonly="readonly"></a>
<a href="eComercialRentalChangesTenantIndex.php" ><input type="text3" value="View Tenants" readonly="readonly"></a>
</div>
...
<?php
					...
					$query=mysqli_query($conn,"select * from `iTaxComercialRentalIncomeAdmin`");
...
<?php
					...
					$query=mysqli_query($conn,"select * from `iTaxComercialRentalIncomeSuperAdmin`");
					while($row=mysqli_fetch_array($query)){
						?>
