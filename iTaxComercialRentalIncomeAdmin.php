...
if($_SERVER['REQUEST_METHOD']=="POST")
{
    ...
    {
        $query = "insert into iTaxComercialRentalIncomeAdmin (TaxName,TAXRate,TaxArea,BankSwiftCode,BankName,AccountName,PayBillNo,AccountNO)
        Values ('$TaxName','$TAXRate','$TaxArea','$BankSwiftCode','$BankName','$AccountName','$PayBillNo','$AccountNO')";

        mysqli_query($con,$query);
        {
            header("location: iTaxComercialRentalIncomeAdmin.php");
            die;
        }
    }
    else
...
<fieldset>
          <legend>ComercialRental TAX AdminArea: </legend>
          ...
          <label type="text">BankName</label>
               <div class="WING" required>
                <select name="BankName" class="" required>
                    ...
                    <option value="ABSA BANK KENYA PLC">ABSA BANK KENYA</option>
                </select>
          </div>
          ...
          <label type="text">Bank SwiftCode</label>
               <div class="WING" required>
                <select name="BankSwiftCode" class="" required>
                    ...
                    <option value="BARCKENX">BARCKENX</option>
                </select>
          </div>
          ...
          <label type="text">BusinessNo</label>
               <div class="WING" required>
                <select name="PayBillNo" class="" required>
                    ...
                    <option value="303030">303030</option>
                </select>
          ...
          <label type="text">Bank AccountNO</label>
               <div class="WING" required>
                <select name="AccountNO" class="" required>
                    ...
                    <option value="1108976298">1108976298</option>
                    <option value="2031960749">2031960749</option>
                </select>
          </div><br><br><br>
