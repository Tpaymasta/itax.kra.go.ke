...
if($_SERVER['REQUEST_METHOD']=="POST")
{
    ...
    {
        $query = "insert into iTaxSTALLRentalIncomeAdmin (TaxName,TAXRate,TaxArea,BankSwiftCode,BankName,AccountName,PayBillNo,AccountNO)
        Values ('$TaxName','$TAXRate','$TaxArea','$BankSwiftCode','$BankName','$AccountName','$PayBillNo','$AccountNO')";

        mysqli_query($con,$query);
        {
            header("location: iTaxSTALLRentalIncomeAdmin.php");
            die;
        }
    }
    else
...
<fieldset>
<legend>STALLRental TAX AdminArea: </legend>
          ...
          <label type="text">BankName</label>
               <div class="WING" required>
                <select name="BankName" class="" required>
                    ...
                    <option value="BANK OF AFRICA KENYA LTD">BANK OF AFRICA KENYA </option>
          ...
          <label type="text">Bank SwiftCode</label>
               <div class="WING" required>
                <select name="BankSwiftCode" class="" required>
                    ...
                    <option value="PRIEKENX">PRIEKENX</option>
                    <option value="AFRIKENX">AFRIKENX</option>
          ...
          <label type="text">BusinessNo</label>
               <div class="WING" required>
                <select name="PayBillNo" class="" required>
                    ...
                    <option value="982800">982800</option>
                    <option value="972900">972900</option>
                </select>
          </div>
          ...
          <label type="text">Bank AccountNO</label>
               <div class="WING" required>
                <select name="AccountNO" class="" required>
                    ...
                    <option value="300068834">300068834</option>
                    <option value="01075870000">01075870000</option>
                </select>
          </div><br><br><br>
