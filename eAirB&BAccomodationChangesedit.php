<?php
	include('conn1.php');
	$ID=$_GET['ID'];
	$query=mysqli_query($conn,"select * from `AirB&BAccomodationCalculater` where ID='$ID'");
...
<a href="AirB&BAccomodationCalculater.php" style="color:red">
               <input type="text2"  value="HOME" readonly="readonly" ></a>
<input type="text3"  value="Change Ownership" readonly="readonly" ></a>

TenantID/PassPort: 

<a href="eAirB&BAccomodationChangesTenantedit.php?ID=<?php echo $row['ID']; ?>" style="color:red">
...
<form method="POST" action="eAirB&BAccomodationChangesUpdate.php?ID=<?php echo $ID; ?>">
...
<div class="container2d4">
               ...
               <a href="eAirB&BAccomodationChangesIndex.php" style="color:red">
