<?php
	include('conn1.php');
	$ID=$_GET['ID'];
	$query=mysqli_query($conn,"select * from `ResidencialRentalCalculater` where ID='$ID'");
...
<a href="eResidencialRentalChangesTenantIndex1.php" style="color:red"><input type="text2"  value="Invoice Tenant" readonly="readonly" ></a>
...
<form method="POST" action="eResidencialRentalChangesTenantUpdate.php?ID=<?php echo $ID; ?>">
...
<fieldset>
      ...
      <div class="container2d4">
               ...
               <a href="eResidencialRentalChangesTenantIndex.php" style="color:red">
