...
<a href="eSTALLRentalChangesTenantIndex1.php" style="color:red"><input type="text2"  value="<<< Back" readonly="readonly" ></a>

<a href="eSTALLRentalChangesTenantedit1.php?ID=<?php echo $row['ID']; ?>" target="_blank" class="btn btn-success pull-right"><span class="glyphicon glyphicon-print"></span></a>
</div>
...
<table>
    ...
    <thead>
     ...
     <tr>
      ...
      <a href="eSTALLRentalChangesTenantedit1.php?ID=<?php echo $row['ID']; ?>" style="color:red">
