...
if($_SERVER['REQUEST_METHOD']=="POST")
{
    ...
    {
        $query = "insert into iTaxRentalIncomeAdmin (TaxName,TAXRate,TaxArea,BankSwiftCode,BankName,PayBillNo,AccountNO)
        Values ('$TaxName','$TAXRate','$TaxArea','$BankSwiftCode','$BankName','$PayBillNo','$AccountNO')";

        mysqli_query($con,$query);
        {
            header("location: iTaxRentalIncomeAdmin.php");
            die;
        }
    }
    else
...
<fieldset>
          <legend>Rental TAX Income Admin: </legend>
             <label type="text">TaxName</label>
               <input type="text" name="TaxName" value="" id="" placeholder="Enter TaxName" required >
               <label type="text">TAXRate</label>
                <input type="text" name="TAXRate" value="" oninput="valid(this)" id="" placeholder="Enter TAXRate"  required >
               
                <label type="text">TaxArea</label>
               <input type="text" name="TaxArea" value="" id="" placeholder="Enter TaxArea" required ><br><br><br>
...
<br>
     ...
     <fieldset>
          ...
          <label type="text">MPESA BusinessNo</label>
               <div class="WING" required>
                <select name="PayBillNo" class="" required>
                    <option value="">MPESABusinessNo</option>
          ...
          <label type="text">Bank AccountNO</label>
               <div class="WING" required>
                <select name="AccountNO" class="" required>
                    ...
                    <option value="0240299657063">0240299657063</option>
                    <option value="7135210017">7135210017 </option>
                </select>
          </div><br><br><br>
