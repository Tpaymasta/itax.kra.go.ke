<?php
	include('conn1.php');
	$ID=$_GET['ID'];
	$query=mysqli_query($conn,"select * from `HotelAccomodationCalculater` where ID='$ID'");
    ...
    <title>Kenya Revenue Authority</title>
        ...
        <script>
            $(document).ready(function(){
                $("#TAXRate,#DailyGross,#Nights,#TotalGrossOnOtherExpence,#VATRate,#VATMaintnceFeeRate").keyup(function(){
...
<a href="eHotelAccomodationDoorUniqueNoIndex.php" ><input type="text3"  value="Back" readonly="readonly" ></a>
...
<form method="POST" action="eHotelAccomodationDoorUniqueNOUpdate.php?ID=<?php echo $ID; ?>">

<fieldset>
      <legend>Door UniqueNo Area: </legend>
        <label type="text">Door UniqueNo</label>
<input type="text" name="SuiteUniqueNo"   id="SuiteUniqueNo" value=" <?php echo $row['KRAPIN']; echo $row['BranchNO']; echo $row['WING']; echo $row['SuiteNo'];?> " readonly='readonly' required></a>
<label type="text">Door</label>
<input type="text" name="Door"   id="Door" value=" <?php echo $row['BranchNO']; echo $row['WING']; echo $row['SuiteNo'];?> " readonly='readonly' required></a>
</fieldset>
...
<button class="btn btn-primary" name="generate">Submit</button>
               ...
               <input type="test" name="ContactNO" value="" id="ContactNO" oninput="valid(this)" placeholder="Tenant ContactNO" >
            
               <input type="test" name="Joitest" value="" id="JoinedDate"  placeholder="Enter JoinedDate" >
               ...
               <input type="test" name="BranchNO" value="<?php echo $row['BranchNO']; ?>" id="" placeholder="Enter BranchNO" required >             
               <input type="test" name="SuiteNo" value="<?php echo $row['SuiteNo']; ?>" id="" placeholder="Enter DoorNo" required >
               <input type="test" name="WING" value="<?php echo $row['WING']; ?>" id="" placeholder="Enter WING" required >
               <input type="test" name="Bank1PayBillNO1" value="" id="Bank1PayBillNO1" oninput="valid(this)"type="test" placeholder="Enter PAYBILLNO" minlength="6" maxlength="6" required>
               <input type="test" name="Bank1AccountNO1" value="" id="Bank1AccountNO1" oninput="valid(this)"type="test"placeholder="Enter ACCOUNTNO" required >
               <input type="test" name="GrossRent" value="" id="GrossRent"oninput="valid(this)"type="test" placeholder="0.00" minlength="1" maxlength="8" required>
    ...
    <script>
      ...
      <input type="test" name="NetRent" value="" id="NetRent" placeholder="NetRent" readonly="readonly">
               <input type="test" name="TAXRate"  id="TAXRate"placeholder="TAXRate" value="" readonly="readonly">
               <input type="test" name="TaxValue" value="" id="TaxValue"placeholder=" TaxValue" readonly="readonly">
               <input type="test" name="MaintnceFeeRate" id="MaintnceFeeRate" value=""placeholder="MaintenceFeeRate" readonly="readonly">
