...
if($_SERVER['REQUEST_METHOD']=="POST")
{
    ...
    {
        $query = "insert into iTaxResidencialRentalIncomeAdmin (TaxName,TAXRate,TaxArea,BankSwiftCode,BankName,AccountName,PayBillNo,AccountNO)
        Values ('$TaxName','$TAXRate','$TaxArea','$BankSwiftCode','$BankName','$AccountName','$PayBillNo','$AccountNO')";

        mysqli_query($con,$query);
        {
            header("location: iTaxResidencialRentalIncomeAdmin.php");
            die;
        }
    }
    else
...
<fieldset>
<legend>ResidencialRental TAX AdminArea: </legend>
             ...
             <div class="WING" required>
               ...
               <div class="WING" required>
                <select name="TaxArea" class="" required>
                    ...
                    <option value="Residencial Rental">Residencial Rental</option>
                </select>
          </div>         
</fieldset>
<br>
          ...
          <label type="text">Bank AccountNO</label>
               <div class="WING" required>
                <select name="AccountNO" class="" required>
                    ...
                    <option value="0021015000002">0021015000002</option>
