...
<a href="STALLRentalDoorUniqueNoIndex.php" ><input type="text3"  value="Back" readonly="readonly" ></a>
...
<form method="POST" action="eSTALLRentalDoorUniqueNOUpdate.php?ID=<?php echo $ID; ?>">
