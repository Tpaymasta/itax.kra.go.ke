<?php
	include('conn1.php');
	$ID=$_GET['ID'];
	$query=mysqli_query($conn,"select * from `SHOPRentalCalculater` where ID='$ID'");
...
<a href="eSHOPRentalChangesTenantIndex1.php" style="color:red"><input type="text2"  value="Invoice Tenant" readonly="readonly" ></a>
...
<form method="POST" action="eSHOPRentalChangesTenantUpdate.php?ID=<?php echo $ID; ?>">
...
<fieldset>
      ...
      <div class="container2d4">
               ...
               <a href="eSHOPRentalChangesTenantIndex.php" style="color:red">
