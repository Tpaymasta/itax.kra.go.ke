...
<a href="ComercialRentalCalculater.php" style="color:red">
               <input type="text2"  value="HOME" readonly="readonly" ></a>
<input type="text3"  value="Change Ownership" readonly="readonly" ></a>

TenantID/PassPort: 

<a href="eComercialRentalChangesTenantedit.php?ID=<?php echo $row['ID']; ?>" style="color:red">
...
<form method="POST" action="eComercialRentalChangesUpdate.php?ID=<?php echo $ID; ?>">
...
<div class="container2d4">
               ...
               <a href="eComercialRentalChangesIndex.php" style="color:red">
